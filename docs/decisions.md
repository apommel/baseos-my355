...
the GPT, it reaches `Run /init` **1.6 s** ahead (2026-09-19). It costs the early boot logo — mainline U-Boot has no VOP2
driver, so `rcS` draws it, on the panel at 2.15 s against ~1.0 s — and the
