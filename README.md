...
the kernel prints its first line at 1.05 s instead of 2.85 s, the frontend
hand-off is at 1.97–2.00 s and NextUI's first frame at 2.93–2.98 s. The cost is
a later boot logo, at 2.03 s instead of ~1.0 s, and the vendor U-Boot's
